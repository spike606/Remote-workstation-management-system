...
{
    [DataContract]
    public class MainBoardDynamic : HardwareDynamicComponent, IHardwareDynamicComponent
    {
            ...
            where T : HardwareDynamicComponent, IHardwareDynamicComponent, new()
        {
            ...
            ohmProvider.GetDynamicData(hardwareDynamicComponentList, new List<HardwareType>() { HardwareType.Mainboard });
