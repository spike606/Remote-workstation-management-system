        ...
        private readonly List<object[]> data = new List<object[]>
        {
            new object[]
            {
                           new ManagamentObjectBuilder()
                                ...
                                .WithProperty(ConstStringHardwareStatic.HARDWARE_COMPONENT_CAPTION, null)
                                ...
                                .WithProperty(ConstStringHardwareStatic.HARDWARE_COMPONENT_DESCRIPTION, null)
                                ...
                                .WithProperty(ConstStringHardwareStatic.HARDWARE_COMPONENT_NAME, null)
                                ...
                                .WithProperty(ConstStringHardwareStatic.HARDWARE_COMPONENT_STATUS, null)
